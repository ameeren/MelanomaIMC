...
p2 <- plotCellFracGroupsSubset(sce[,which(sce$treatment_group_before_surgery == "untreated" & sce$treatment_group_after_surgery == "ICI")],CellClass = "celltype",split_by = "Death",celltype_subset = "Tcytotoxic",cluster_col = "celltype_clustered")
