...
```{r Fig_1B_UMAP_celltype_RNA, fig.width=7, fig.height=5, dev=c('png', 'pdf')}
...
```{r Fig_1B_Scaled_Heatmap_RNA, fig.width=6, fig.height=5, dev=c('png', 'pdf')}
# aggregate celltypes
...
```{r Fig_1B_UMAP_celltype_Protein, fig.width=7, fig.height=5, dev=c('png', 'pdf')}
dittoDimPlot(cur_sce, 
             reduction.use = "UMAP", 
             var = "celltype", 
             size = 0.7,
...
```{r Fig_1C_Scaled_Heatmap_Protein, fig.width=6, fig.height=6, dev=c('png', 'pdf')}
# aggregate celltypes
