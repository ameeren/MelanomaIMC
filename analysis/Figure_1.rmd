...
```{r Fig_1C_Scaled_Heatmap_RNA, fig.width=19, fig.height=12, dev=c('pdf')}
...
```{r Fig_1C_Scaled_Heatmap_Protein, fig.width=19, fig.height=12, dev=c('pdf')}
# add marker expression to cells
...
```{r Fig_1F_Protein_Barplot, fig.width=19.2, fig.height=8.3, dev=c('pdf')}
