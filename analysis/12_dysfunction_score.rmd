...
## Derive Scoring
We divide the images with a high CD8 cell density into two groups: low dysfunction (CD8+CXCL13+ < 5%) and high dysfunction (CD8+CXCL13+ >= 5%)
...
dysfunction <- data.frame(colData(sce_rna)) %>%
  ...
  #filter(MM_location != "LN") %>% ################### ATTENTION #################
