...
cur_df <- reshape2::dcast(cur_df,formula = "ImageNumber + E_I_D + inside_tumor + Tcell_density_score_image ~ celltype")

cur_df <- cur_df[,c("ImageNumber","E_I_D","inside_tumor", "Tcell_density_score_image","Tcytotoxic")]

cur_df <- reshape2::dcast(cur_df,formula = "ImageNumber + E_I_D + Tcell_density_score_image~ inside_tumor")

colnames(cur_df) <- c("ImageNumber" , "E_I_D" ,"Tcell_density_score_image", "outside_tumor", "inside_tumor")
