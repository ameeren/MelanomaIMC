...
```{r Supp_Fig_5E_chemokine_detection,fig.height=7, fig.width=17, dev=c("pdf"), dpi=25}
...
p <- ggplot(data.frame(similarity = sim_tibble$mean_similarity,
...
ggsave("milieu_sequence_similarity.pdf", p, width = 7, height = 5)
...
```{r Supp_Fig_5H_tumor_cells_chemokine, dev=("pdf"), fig.width=9, fig.height=5}
