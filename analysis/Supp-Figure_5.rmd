...
```{r, Supp_Fig_5C_tcf7_pd1_tcell_corr, fig.width=8.3, fig.height=5.3, dev=("pdf")}
...
```{r, Supp_Fig_5D_responder_nonresponder_tcf7pd1, fig.height=5.3, fig.width=13.2, dev=("pdf")}
...
```{r Supp_Fig_5E_chemokines_tcfpd1_correlation, fig.height=6.2, fig.width=10.1, dev=("pdf")}
