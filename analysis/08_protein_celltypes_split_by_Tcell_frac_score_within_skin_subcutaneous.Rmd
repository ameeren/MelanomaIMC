...
p1 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Thelper", celltype_cluster_col="celltype_clustered",scale = "count")
p2 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Thelper", celltype_cluster_col="celltype_clustered",scale = "percent")+theme(legend.position = "none")
p3 <- plotCellFracGroupsSubset(sce,CellClass = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset = "Thelper",cluster_col = "celltype_clustered")
...
p1 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Tregulatory", celltype_cluster_col="celltype_clustered",scale = "count")
p2 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Tregulatory", celltype_cluster_col="celltype_clustered",scale = "percent")+theme(legend.position = "none")
p3 <- plotCellFracGroupsSubset(sce,CellClass = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset = "Tregulatory",cluster_col = "celltype_clustered")
...
```{r Macrophage cluster fractions for T_frac_score_per_ImageNumber, fig.height=10, fig.width=20, message=FALSE}
...
```{r marker profile of each Tumor cluster, fig.width=10, fig.height=10}
...
__it seems that tumor cluster 1 which is S100+ but low for all other tumor markers is associated with low T cytotoxic cells numbers. inversly, tumor cells which express S100 and additionally express Sox10 and especially MITF seem to be highly enriched in samples with many T cytotoxic cells.__
...
p1 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Bcell", celltype_cluster_col="celltype_clustered",scale = "count")
p2 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="Bcell", celltype_cluster_col="celltype_clustered",scale = "percent")+theme(legend.position = "none")
p3 <- plotCellFracGroupsSubset(sce,CellClass = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset = "Bcell",cluster_col = "celltype_clustered")

bottom_row <- plot_grid(p1, p2, ncol = 2, rel_widths = c(1,1))
plot_grid(p3,bottom_row, ncol = 1, rel_heights = c(2,1))
```

__while not as nicely visible as in the whole cohort, but clearly, no Tcytotoxic cells are also associated with a complete lack of Bcells__
...
p1 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="BnTcell", celltype_cluster_col="celltype_clustered",scale = "count")
p2 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="BnTcell", celltype_cluster_col="celltype_clustered",scale = "percent")+theme(legend.position = "none")
p3 <- plotCellFracGroupsSubset(sce,CellClass = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset = "BnTcell",cluster_col = "celltype_clustered")

bottom_row <- plot_grid(p1, p2, ncol = 2, rel_widths = c(1,1))
plot_grid(p3,bottom_row, ncol = 1, rel_heights = c(2,1))
```

__we have literally classified 0!!! BnTcells in samples with no Tcytotoxic!__
...
p1 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="pDC", celltype_cluster_col="celltype_clustered",scale = "count")
p2 <- plotBarFracCluster(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset ="pDC", celltype_cluster_col="celltype_clustered",scale = "percent")+theme(legend.position = "none")
p3 <- plotCellFracGroupsSubset(sce,CellClass = "celltype",split_by = "T_frac_score_per_ImageNumber",celltype_subset = "pDC",cluster_col = "celltype_clustered")
