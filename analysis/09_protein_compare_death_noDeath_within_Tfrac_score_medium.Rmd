...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tcytotoxic" ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tcytotoxic" ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tcytotoxic"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Thelper"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Thelper"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Thelper"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tregulatory"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tregulatory"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tregulatory"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Macrophage"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Macrophage"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Macrophage"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tumor"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tumor"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tumor"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Bcell"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Bcell"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Bcell"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "BnTcell"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "BnTcell"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "BnTcell"  ) ],CellClass = "celltype_clustered",color_by = "Death")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "pDC"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "pDC"  ) ],colour_by = "celltype_clustered",split_by = "Death", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "pDC"  ) ],CellClass = "celltype_clustered",color_by = "Death")
