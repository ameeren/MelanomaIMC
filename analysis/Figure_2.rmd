...
```{r Fig_2D_tumor_cells_chemokine, dev=("pdf"), fig.width=9, fig.height=5}
...
```{r Fig_2F_cd8_chemokine_correlation, fig.width=13, fig.height=5.7, dev=("pdf")}
# sum
...
sum$celltype_chemo <- factor(sum$celltype_chemo, levels = c("pDC ~ CXCL12", "Tregulatory ~ CCL22","Tcytotoxic ~ CXCL9"))
