...
```{r Fig_2D_correlation_chemokines, fig.width=9, fig.height=9, dev=c('pdf')}
...
```{r Fig_2E_pearson_correlation_chemokines_prot_data, fig.width=9, fig.height=9, dev=c('pdf')}
# top abundant chemokines
cur_rna <- data.frame(colData(sce_rna))
