...
# Introduction
This script generates plots for Supplementary Figure 13, which shows Figure 5 without any LN samples.
...
```{r Supp_Fig_13A_interaction_chord_groups, fig.height=7, fig.width=5, dev=c('pdf')}
...
```{r Supp_Fig_13A_legend, dev=c('pdf'), fig.height=5, fig.width=1.5}
...
```{r Supp_Fig_13B_celltype_fractions_dysfunction, dev=("pdf"), fig.width=8.6, fig.height=5.35}
...
```{r Supp_Fig_13C_bcell_groups_fraction, dev=("pdf"), fig.width=10, fig.height=3}
...
```{r Supp_Fig_13D_Bcell_patches_CXCL13_fractions, fig.height=6.2, fig.width=7.9, dev=c('pdf')}
...
```{r Supp_Fig_13E_clusters_and_communities, fig.width=6, fig.height=6, dev=c('pdf')}
...
```{r Supp_Fig_13F_cd8_tcf7_pd1_bcells, dev=("pdf"), fig.width=6.66, fig.height=3.16}
celltypes <- data.frame(colData(sce_prot)) %>%
  mutate(mmLocationPunch = paste(MM_location, Location, sep = "_")) %>%
...
```{r Supp_Fig_13F_zoom, dev=("pdf"), fig.width=4.1, fig.height=2}
...
```{r Supp_Fig_13G_milieu_presence_tcells, fig.height=4, fig.width=4.9, dev=("pdf")}
