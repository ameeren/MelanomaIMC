...
SKCM_GSE123139 <- read_Data(data = "W:/Daniel/scRNAseq/SKCM_GSE123139_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/SKCM_GSE123139_CellMetainfo_table.tsv",
                      name = "SKCM_GSE123139",
                      sorting = "immune")

SKCM_GSE72056 <- read_Data(data = "W:/Daniel/scRNAseq/SKCM_GSE72056_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/SKCM_GSE72056_CellMetainfo_table.tsv",
                      name = "SKCM_GSE72056",
                      sorting = "all")

SKCM_GSE115978 <- read_Data(data = "W:/Daniel/scRNAseq/SKCM_GSE115978_aPD1_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/SKCM_GSE115978_aPD1_CellMetainfo_table.tsv",
                      name = "SKCM_GSE115978",
                      sorting = "all")

SKCM_GSE120575 <- read_Data(data = "W:/Daniel/scRNAseq/SKCM_GSE120575_aPD1aCTLA4_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/SKCM_GSE120575_aPD1aCTLA4_CellMetainfo_table.tsv",
                      name = "SKCM_GSE120575",
                      sorting = "immune")

HNSC_GSE139324 <- read_Data(data = "W:/Daniel/scRNAseq/HNSC_GSE139324_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/HNSC_GSE139324_CellMetainfo_table.tsv",
                      name = "HNSC_GSE139324",
                      sorting = "immune")

NSCLC_GSE131907 <- read_Data(data = "W:/Daniel/scRNAseq/NSCLC_GSE131907_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/NSCLC_GSE131907_CellMetainfo_table.tsv",
                      name = "NSCLC_GSE131907",
                      sorting = "all")

PAAD_CRA001160 <- read_Data(data = "W:/Daniel/scRNAseq/PAAD_CRA001160_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/PAAD_CRA001160_CellMetainfo_table.tsv",
                      name = "PAAD_CRA001160",
                      sorting = "all")

UVM_GSE139829 <- read_Data(data = "W:/Daniel/scRNAseq/UVM_GSE139829_expression.h5",
                      metadata_file = "W:/Daniel/scRNAseq/UVM_GSE139829_CellMetainfo_table.tsv",
                      name = "UVM_GSE139829",
                      sorting = "all")
