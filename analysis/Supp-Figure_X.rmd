...
a <- ggplot(data=data[data$bcell_patch_score != "B cell Follicles",],
            aes(x=`CD8+ T cell_1`, y=`B cell`)) + 
  geom_point() +
  geom_smooth(method="lm") +
  stat_cor(method = "pearson",
           aes(label = paste(..r.label.., ..p.label.., sep = "~`,`~")),
...
b <- ggplot(data=data,aes(x=`CD8+ T cell_1`, y=`B cell`)) + 
  geom_point() +
  geom_smooth(method="lm") +
  stat_cor(method = "pearson",
           aes(label = paste(..r.label.., ..p.label.., sep = "~`,`~")),
...
c <- ggplot(data=data[data$bcell_patch_score == "B cell Follicles",],aes(x=(`HLA-DR_1`), y=(`B cell`))) + 
  geom_point() +
  geom_smooth(method="lm") +
  ...
  theme_bw() +
  theme(text=element_text(size=15)) +
  xlab("CXCL13+ HLA-DR T cells / mm2") +
  ylab("B cells / mm2")

d <- ggplot(data=data[data$bcell_patch_score == "B cell Follicles",],aes(x=(`CD8+ T cell_1`+`CD8- T cell_1`), y=(`B cell`))) + 
  geom_point() +
  geom_smooth(method="lm") +
  stat_cor(method = "spearman",
           aes(label = paste(..r.label.., ..p.label.., sep = "~`,`~")),
