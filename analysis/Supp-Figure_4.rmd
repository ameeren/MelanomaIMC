...
```{r Supp_Fig_4A_number_of_samples, fig.height=6, fig.width=17, dev=c('pdf')}
...
```{r Supp_Fig_4B_gating_scheme_protein, fig.height=8, fig.width=6, dev=("pdf")}
...
```{r Supp_Fig_4C_gating_scheme_rna, fig.height=8, fig.width=6, dev=("pdf")}
for(element in cur_sces){
  # current labelled sce object
  sce_label <- element
  cur_celltype <- unique(sce_label$cytomapper_CellLabel)
