...
```{r Supp_Fig_4A_heatmap_modules_infiltration, fig.height=8, fig.width=14, dev=c('pdf')}
...
```{r Supp_Fig_4A_legend, dev=c('pdf'), fig.width=3, fig.height=1}
# manual legends
...
```{r Supp_Fig_4B_Scaled_Heatmap_Protein, fig.width=11, fig.height=11, dev=c('pdf')}
...
```{r Supp_Fig_4C_tumor_profile_per_image, fig.height=8, fig.width=7, dev=c('pdf')}
...
```{r Supp_Fig_4D_S100_manual, fig.height=5, fig.width=5, dev=c('pdf')}
# manual gating 
