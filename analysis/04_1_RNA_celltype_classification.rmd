...
label.files <- list.files("data/rna/celltype_classifier/", full.names = TRUE)
...
# Save in SCE object
metadata(sce)$colour_vectors$classified_celltypes <- layer1_colours
```
...
saveRDS(layer_1_dat, "data/layer_1_classification_rna.csv")
```
