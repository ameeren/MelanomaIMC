...
# remove exact date in clinical data
clinicalDat$Date_death <- format(as.Date(clinicalDat$Date_death),"01-%b-20%y")
clinicalDat$Date_surgery <- format(as.Date(clinicalDat$Date_surgery),"01-%b-20%y")
clinicalDat$Date_progression <- format(as.Date(clinicalDat$Date_progression),"01-%b-20%y")
clinicalDat$Start_treatment <- format(as.Date(clinicalDat$Start_treatment),"01-%b-20%y")
clinicalDat$End_treatment <- format(as.Date(clinicalDat$End_treatment),"01-%b-20%y")
clinicalDat$Last_PET <- format(as.Date(clinicalDat$Last_PET),"01-%b-20%y")
...
write.csv2(clinicalDat, "~/bbDQBM/Git/MelanomaIMC/Table_S4.csv", row.names = FALSE)
```
