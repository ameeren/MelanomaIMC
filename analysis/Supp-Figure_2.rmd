...
```{r Supp_Figure_2A, fig.height=8, fig.width=19, dev=c('png', 'pdf')}
...
```{r Supp_Figure_2B, fig.height=14,fig.width=20, dev=c('png', 'pdf')}
cur_df <- dat %>%
...
# rename E_I_D scoring
cur_df[cur_df$E_I_D == "1",]$E_I_D <- "Excluded"
cur_df[cur_df$E_I_D == "2",]$E_I_D <- "Inflamed"
cur_df[cur_df$E_I_D == "3",]$E_I_D <- "Deserted"
cur_df[cur_df$E_I_D == "1_2",]$E_I_D <- "Excluded/Inflamed"
...
```{r Supp_Figure_2C, fig.height=14,fig.width=20, dev=c('png', 'pdf')}
c <- cur_df %>%
