...
## T_frac_score_per_ImageNumber analysis

```{r chemokine expression by T_frac_score_per_ImageNumber boxplot, fig.height=12, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)+scale_fill_manual(values = colour_vector)
p2 <- plotCellCounts(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+scale_fill_manual(values = colour_vector)
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tcytotoxic" ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tcytotoxic" ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tcytotoxic"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
## Thelper cluster fractions and marker profile for T_frac_score_per_ImageNumber

```{r Thelper cluster fractions for T_frac_score_per_ImageNumber, fig.height=10, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce[,which(sce$celltype == "Thelper"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Thelper"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Thelper"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
## Tregulatory cluster fractions and marker profile for T_frac_score_per_ImageNumber

```{r Tregulatory cluster fractions for T_frac_score_per_ImageNumber, fig.height=10, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tregulatory"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tregulatory"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tregulatory"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
```{r Macropahges cluster fractions for T_frac_score_per_ImageNumber, fig.height=10, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce[,which(sce$celltype == "Macrophage"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Macrophage"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Macrophage"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Tumor"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Tumor"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Tumor"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
cur_df$T_frac_score_per_ImageNumber <- sce$T_frac_score_per_ImageNumber
...
cur_df_long %>%
  ...
  ggplot()+
  geom_boxplot(aes(x = celltype_clustered,y=value, fill=T_frac_score_per_ImageNumber))+
  facet_wrap(~variable)+
...
p1 <- plotCellCounts(sce[,which(sce$celltype == "Bcell"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "Bcell"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "Bcell"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
## BnTcell cluster fractions and marker profile for T_frac_score_per_ImageNumber

```{r BnTcell cluster fractions for T_frac_score_per_ImageNumber, fig.height=15, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce[,which(sce$celltype == "BnTcell"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "BnTcell"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "BnTcell"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
...
## pDC cluster fractions and marker profile for T_frac_score_per_ImageNumber

```{r pDC cluster fractions for T_frac_score_per_ImageNumber, fig.height=15, fig.width=20, message=FALSE}
p1 <- plotCellCounts(sce[,which(sce$celltype == "pDC"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce[,which(sce$celltype == "pDC"  ) ],colour_by = "celltype_clustered",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
p3 <- plotCellFracGroups(sce[,which(sce$celltype == "pDC"  ) ],CellClass = "celltype_clustered",color_by = "T_frac_score_per_ImageNumber")
