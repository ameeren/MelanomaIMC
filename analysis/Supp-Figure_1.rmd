...
```{r Supp_Fig_1B_merged_comparison_per_channel, fig.width=10, fig.height=7, dev=c('pdf')}
# subset
...
```{r Supp_Fig_1C_median_comparison_per_replicate, fig.width=10, fig.height=8, dev=c('pdf')}
