...
```{r Supp_Fig_1A_heatmap_unspecific_binding, dev=c('pdf')}
...
## Load the data
```{r}
cells1 = fread("data/12plex_validation/HeLa/20190208/cell.csv", header = T,sep=",")
...
```{r Supp_Fig_1B_merged_comparison_per_channel, fig.width=10, fig.height=8, dev=c('pdf')}
# subset
...
```{r Supp_Fig_1D_correlation_with_RNAseq, fig.width=8, fig.height=7, dev=c('pdf')}
# add gene name
...
```{r Supp_Fig_1E1F_chemokine_detection,fig.height=7, fig.width=17, dev=c("pdf"), dpi=25}
