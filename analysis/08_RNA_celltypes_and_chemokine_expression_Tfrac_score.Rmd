...
p1 <- plotCellCounts(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber", proportion = FALSE)
p2 <- plotCellCounts(sce,colour_by = "celltype",split_by = "T_frac_score_per_ImageNumber", proportion = TRUE)+theme(legend.position = "none")
...
__the pure community for CCL4 seems to induce the expression of Lag3 more strongly than the pure community of CXCL13. Botch those communities induce similar levels of PD1 expression__
