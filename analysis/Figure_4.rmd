...
```{r barplot_clinical_annotation, dev=c('png', 'pdf'), fig.height=10, fig.width=15}
set.seed(362)
...
```{r hazard_ratios, dev=c('png', 'pdf'), fig.width=16}
...
```{r heatmap_modules_infiltration, fig.height=10, fig.width=14, dev=c('png', 'pdf')}
# subset df
