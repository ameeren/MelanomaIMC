...
```{r Fig_4D_interaction_cytotoxic_tumor_boxplots, fig.width=8.8, fig.height=4, dev=("pdf")}
...
```{r Fig_4E_tumor_profile_per_image, fig.height=4.8, fig.width=7.6, dev=c('pdf')}
...
```{r Fig_4F_S100_dysfunction, dev=("pdf"), fig.width=7.7, fig.height=3.5}
...
```{r, Fig_4G_responder_nonresponder_tumor, fig.height=4, fig.width=8.8, dev=("pdf")}
