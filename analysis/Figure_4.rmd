...
exhaustion <- data.frame(colData(sce_rna)) %>%
  filter(Location != "CTRL") %>%
  filter(T_frac_score_per_ImageNumber %in% c("high")) %>%
...
sce_rna$exhaustion_density <- paste(sce_rna$T_frac_score_per_ImageNumber, sce_rna$exhaustion_score, sep = " - ")
...
sce_prot$exhaustion_density <- paste(sce_prot$T_frac_score_per_ImageNumber, sce_prot$exhaustion_score, sep = " - ")
```
