...
```{r Supp_Fig_8A_expressor_cd8_grouping, fig.width=14, fig.height=5, dev=("pdf")}
targets <- metadata(sce_rna)$chemokines_morethan600_withcontrol
...
```{r Supp_Fig_8B_expressor_dend_cluster, fig.width=14, fig.height=5, dev=("pdf")}
...
```{r Supp_Fig_8C_patch_analysis, dev=("pdf"), fig.height=5, fig.width=8}
dat <- image_df %>%
