...
```{r}
all_mask <- loadImages(x = "/Volumes/server_homes/daniels/Data/Melanoma/12plex/RNA/cpout/",pattern = "ilastik_s2_Probabilities_equalized_cellmask.tiff")
all_pixel <- loadImages(x = "/Volumes/server_homes/daniels/Data/Melanoma/12plex/RNA/tiffs/",pattern = "_full.tiff")
```
...
image_mat <- as.data.frame(read.csv(file = "/Volumes/server_homes/daniels/Data/Melanoma/12plex/RNA/cpout/Image.csv",stringsAsFactors = FALSE))
