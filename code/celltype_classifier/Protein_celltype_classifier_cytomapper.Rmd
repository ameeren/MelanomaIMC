...
```{r}
all_mask <- loadImages(x = "/Volumes/server_homes/daniels/Data/Melanoma/12plex/protein/cpout/",pattern = "ilastik_s2_Probabilities_equalized_cellmask.tiff")
all_pixel <- loadImages(x = "/Volumes/server_homes/daniels/Data/Melanoma/12plex/protein/tiffs/",pattern = "_full.tiff")
```
...
```{r add channel names}
panel_meta <- read.csv(file = "data/protein/melanoma_1.06_protein.csv", sep= ",",  stringsAsFactors = FALSE )
