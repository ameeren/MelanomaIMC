...
```{r}
all_mask <- loadImages(x = "data/full_data/protein/cpout/",pattern = "ilastik_s2_Probabilities_equalized_cellmask.tiff")
all_pixel <- loadImages(x = "data/full_data/protein/tiffs/",pattern = "_full.tiff")
```
...
```{r add channel names}
panel_meta <- read.csv(file = "data/data_for_analysis/protein/melanoma_1.06_protein.csv", sep= ",",  stringsAsFactors = FALSE )
